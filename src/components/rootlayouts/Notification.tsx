...
export default function Notification() {
  ...
  return (
    <div className="h-full border-white flex flex-col justify-between">
      ...
      {/* 모바일용 알림창 */}
      <div
        className="tablet:hidden flex flex-col items-center gap-[20px] 
      pt-[50px] px-[20px]"
      >
        <SideToggleList
          title="시리즈"
        ...
        {/* 언어변경 버튼 */}
        <div
          className="w-full h-full border-white border-1
        flex justify-between items-center cursor-pointer"
          onClick={() => setIsTranslate((prev) => !prev)}
        >
          <div className="text-white01 flex justify-between">언어변경</div>
