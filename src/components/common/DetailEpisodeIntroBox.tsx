    ...
    <>
      ...
      >
        ...
        <section className="w-full h-auto flex flex-col gap-[35px] justify-between tablet:pb-[100px] tablet:pt-[50px] desktop:px-[136px] tablet:px-[31px] mobile:px-[10px]">
          <div className="w-full flex tablet:flex-row mobile:flex-col-reverse justify-between  gap-[50px] relative z-10 text-left text-white">
            ...
            <img
              ...
              alt="placeholder"
              className="tablet:w-[369px] tablet:h-[205px] mobile:w-full mobile:h-auto rounded-[10px] z-10"
            />
          </div>
