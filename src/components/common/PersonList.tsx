export default function PersonList({}) {
  return (
    ...
    <p className="tablet:text-[24px] text-semibold mobile:text-[18px] text-white01">출연진</p>
    <div className="flex gap-[30px]">
      <figure className="flex flex-col gap-[5px]">
        <img src="" className="bg-white tablet:w-[100px] mobile:w-[60px] aspect-square rounded-full z-10"/>
